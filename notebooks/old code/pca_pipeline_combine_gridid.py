...
if __name__ == '__main__':
    ...
    normalized_input.loc[(normalized_input.grid_id == 333519) & (normalized_input.domain.isin(cb_333519)),'label'] = 1
    normalized_input.loc[(normalized_input.grid_id == 333346) & (normalized_input.domain.isin(cb_333346)),'label'] = 1
    ...
    pca_df['grid_id'] = normalized_input['grid_id']
    pca_df['domain'] = normalized_input['domain']
    pca_df['label'] = normalized_input['label']
    ...
    plt.title(f'PCA scatterplot all-all')
